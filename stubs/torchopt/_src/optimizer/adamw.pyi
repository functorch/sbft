...
class AdamW(Optimizer):
    ...
    """
    def __init__(self, params: Iterable[torch.Tensor], lr: ScalarOrSchedule = ..., betas: Tuple[float, float] = ..., eps: float = ..., weight_decay: float = ..., *, eps_root: float = ..., mask: Optional[Union[Any, Callable[[base.Params], Any]]] = ..., maximize: bool = ..., use_accelerated_op: bool = ...) -> None:
