...
class MetaRMSProp(MetaOptimizer):
    ...
    """
    def __init__(self, net: nn.Module, lr: ScalarOrSchedule = ..., alpha: float = ..., eps: float = ..., weight_decay: float = ..., momentum: float = ..., centered: bool = ..., *, initial_scale: float = ..., nesterov: bool = ..., maximize: bool = ...) -> None:
